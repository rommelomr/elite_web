  ...
  <v-container>
    <v-card>
      ...
      <v-card-text>
        <center>
          <p>
            Los datos de su reserva han sido enviados a la dirección de correo
            especificada.
          </p>
          <br />

          <p>
            La recepción y devolución de coches se realiza entre las
            <u>5:00 am y las 1:00 am</u><br />. Posterior a nuestro horario
            conllevará un recargo de un día de servicio y el coche será
            entregado en nuestro horario laborable.
          </p>
          <br />
...
export default {
  ...
  mounted() {
    ...
    if (
      !this.stored_reservation_setted &&
  ...
  computed: {
    ...mapFields({
      stored_reservation_setted:
        "confirmed_reservation.confirmed_reservation_setted",
